 ...
 *  Table: lns_training
 *
 *  Purpose: Store data for lns training task. 
 *
 */
class Model_lns_training extends Model{
  ...
  public $num_correct;       //How many blocks the user selected
  public $abs_correct;       //If the user selected all the correct blocks
