<?php
class Model_memnosyne_training_parameters extends Model{
  /**
   *  Table: memnosyne_training_parameters
   *
   *  Stores information for an experiments parameters for training task memnosyne
   *
   *  @author: MikeD
   *
   */
  ...
  const TABLE_NAME = "memnosyne_training_parameters";
