...
require_once(AMFSERVICES.'/../../../models/model_shapebuilder_assessment.php');
class Service_shapebuilder_assessment extends Model_shapebuilder_assessment{
  ...
  */
  ...
  function get_schema($schemaName){
    ...
    $data = read_file('default_assessment.xml');
