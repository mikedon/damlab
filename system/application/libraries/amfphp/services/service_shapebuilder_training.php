...
require_once(AMFSERVICES.'/../../../models/model_shapebuilder_training.php');
class Service_shapebuilder_training extends Model_shapebuilder_training{
  ...
  /*
  function getHighStimCount(){
    return $this->get_high_stimCount();
